...
//  *
//  * The Odometry class uses the data from a gyro and optional tracking wheels
//  to
//  * calculate the position and heading of the robot. The class uses a Kalman
//  * filter to smooth the data and give the most accurate readings. The class
//  also
...
//  * @param parallelWheelSensor The rotation sensor object to use for getting
//  the
//  * parallel wheel data. Set to nullptr to disable.
//  * @param perpendicularWheelSensor The rotation sensor object to use for
//  getting
...
//  * @param tracking_wheel_diameter The diameter of the tracking wheel in
//  inches.
//  */
// class Odometry {
// public:
...
// private:
//   pros::Imu &imu;
//   pros::Rotation *parallelWheelSensor; // Pointer to allow for optional
//   sensor pros::Rotation
