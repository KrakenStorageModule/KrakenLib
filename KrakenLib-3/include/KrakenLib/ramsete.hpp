...
// public:
//     RamseteController(double k1, double k2, double k3, double L, double
//     max_velocity, double max_voltage);

//     void update(const Point& currentPose, const Point& desiredState);
//     void applyMotorVoltages(pros::MotorGroup& leftDrive, pros::MotorGroup&
//     rightDrive); double sinc(double x);
// private:
