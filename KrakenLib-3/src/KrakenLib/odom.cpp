...
void Odometry::calculateOdometry() {
  ...
  double deltaX = deltaParallel * std::cos(headingRad) - deltaPerpendicular * std::sin(headingRad);
  double deltaY = deltaParallel * std::sin(headingRad) + deltaPerpendicular * std::cos(headingRad);
